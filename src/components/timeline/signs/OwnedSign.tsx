...
export const SignStyle = styled(Stack)<{
  ...
  font-weight: bold;
  background-color: ${(props) => props.themeOptions.palette.propertyStatusOwnedBackground};
...
export function OwnedSign() {
  const coreTheme = useTheme() as IThemeOptions;
  return <SignStyle themeOptions={coreTheme}>OWNED</SignStyle>;
}
